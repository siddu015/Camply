          ...
          <div className="relative w-full mt-10 max-w-xl mx-auto">
            {files.length > 0 &&
              files.map((file, idx) => (
                <motion.div
                  ...
                  className={cn(
                    "relative overflow-hidden z-40 bg-background border border-border flex flex-col items-start justify-start md:h-24 p-4 mt-4 w-full mx-auto rounded-md",
                    "shadow-sm"
                  )}
                >
            ...
            {!files.length && (
              <motion.div
                ...
                className={cn(
                  "relative group-hover/file:shadow-2xl z-40 bg-background border border-border flex items-center justify-center h-32 mt-4 w-full max-w-[8rem] mx-auto rounded-md",
              ...
              className={cn(
                ...
                index % 2 === 0
                  ...
                  : isDark 
                    ...
                    : "bg-background shadow-[0px_0px_1px_3px_rgba(255,255,255,1)_inset]"
              )}
            />
          );
        })
