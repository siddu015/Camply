...
async def search_campus_intelligence(query: str, search_type: str = "general", *, tool_context) -> Dict[str, Any]:
    try:
        ...
        formatted_response = generate_intelligent_response(
            query, query_analysis, college_name, relevant_content, user_data
        )
        ...
        response_data = {
            ...
            "metadata": {
                ...
                "personalized": bool(academic_details.get("branch_name")),
...
def format_dict_content(content_data: Dict) -> str:
    """Format dictionary content into readable text for display"""
    if not content_data:
    ...
    if isinstance(content_data, str):
        ...
        for key, value in content_data.items():
            ...
            if key in ['created_at', 'updated_at', 'id', 'campus_content_id', 'content_version']:
                continue
            ...
            if isinstance(value, (dict, list)):
                ...
                formatted_lines.append(f"{section_title}: {value}")
    ...
    if relevant_content:
        ...
        for content_type, content_data in relevant_content.items():
            ...
            if isinstance(content_data, dict):
                formatted_content = format_dict_content(content_data)
            else:
